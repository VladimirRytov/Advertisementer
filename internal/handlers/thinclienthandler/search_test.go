...
func TestOrdersByClientID(t *testing.T) {
	...
	req.OrdersByClientName(Clients[0].Name)
	if OrdersError != nil {
		t.Fatal(OrdersError)
	}
...
func TestBlockAdvertisementsByOrderID(t *testing.T) {
	...
	req.BlockAdvertisementsByOrderID(Orders[0].ID)
...
func TestBlockAdvertisementsBetweenReleaseDates(t *testing.T) {
	...
	req.BlockAdvertisementsBetweenReleaseDates(time.Date(2000, 12, 12, 12, 0, 0, 0, time.UTC), time.Now().AddDate(22, 2, 2))
	if BlockAdvertisementsError != nil {
		t.Fatal(BlockAdvertisementsError)
	}
...
func TestBlockAdvertisementsActualReleaseDate(t *testing.T) {
	...
	req.BlockAdvertisementsActualReleaseDate()
	if BlockAdvertisementsError != nil {
		t.Fatal(BlockAdvertisementsError)
	}
...
func TestBlockAdvertisementsFromDate(t *testing.T) {
	...
	req.BlockAdvertisementsFromReleaseDate(time.Date(2000, 12, 12, 12, 0, 0, 0, time.UTC))
	if BlockAdvertisementsError != nil {
		t.Fatal(BlockAdvertisementsError)
	}
...
func TestLineAdvertisementsByOrderID(t *testing.T) {
	...
	req.LineAdvertisementsByOrderID(Orders[0].ID)
...
func TestLineAdvertisementsBetweenReleaseDates(t *testing.T) {
	...
	req.LineAdvertisementsBetweenReleaseDates(time.Date(2000, 12, 12, 12, 0, 0, 0, time.UTC), time.Now().AddDate(2, 2, 2))
	if LineAdvertisementsError != nil {
		t.Fatal(LineAdvertisementsError)
	}
...
func TestLineAdvertisementsActualReleaseDate(t *testing.T) {
	...
	req.LineAdvertisementsActualReleaseDate()
	if LineAdvertisementsError != nil {
		t.Fatal(LineAdvertisementsError)
	}
...
func TestLineAdvertisementsFromDate(t *testing.T) {
	...
	req.LineAdvertisementsFromReleaseDate(time.Date(2000, 12, 12, 12, 0, 0, 0, time.UTC))
	if LineAdvertisementsError != nil {
		t.Fatal(LineAdvertisementsError)
	}
