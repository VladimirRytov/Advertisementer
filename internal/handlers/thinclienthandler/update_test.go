...
func TestUpdateBlockAdvertisement(t *testing.T) {
	...
	req.UpdateBlockAdvertisement(newBlockDtoForTest)
...
func TestUpdateLienAdvertisement(t *testing.T) {
	...
	req.UpdateLineAdvertisement(newLineDtoForTest)
...
func TestUpdateExtraCharge(t *testing.T) {
	...
	req.UpdateExtraCharge(newExtraChargeDTO)
